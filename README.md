...
The framework is implemented incrementally by feature block. Block 9 covers runtime internals, reset, and failure reporting.

## Installation

```swift
.package(url: "https://github.com/RafaelPena31/MockSyn.git", from: "0.9.0")
```
