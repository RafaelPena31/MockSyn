...
The framework is implemented incrementally by feature block. Version 0.29.0 adds rich runtime argument rendering in failure messages.

## Installation

```swift
.package(url: "https://github.com/RafaelPena31/MockSyn.git", from: "0.29.0")
```
