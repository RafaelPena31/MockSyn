...
The framework is implemented incrementally by feature block. Version 0.20.0 supports class initializer mirroring for subclass-based doubles.

## Installation

```swift
.package(url: "https://github.com/RafaelPena31/MockSyn.git", from: "0.20.0")
```
