...
The framework is implemented incrementally by feature block. Block 5 covers runtime stubbing with generated `given` / `when` APIs.

## Installation

```swift
.package(url: "https://github.com/RafaelPena31/MockSyn.git", from: "0.5.0")
```
