...
The framework is implemented incrementally by feature block. Block 8 covers test double modes, spies, partial spies, and fake helpers.

## Installation

```swift
.package(url: "https://github.com/RafaelPena31/MockSyn.git", from: "0.8.0")
```
