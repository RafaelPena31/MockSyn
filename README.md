...
The framework is implemented incrementally by feature block. Block 6 covers runtime verification with generated `verify` APIs.

## Installation

```swift
.package(url: "https://github.com/RafaelPena31/MockSyn.git", from: "0.6.0")
```
