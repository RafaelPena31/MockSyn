...
The framework is implemented incrementally by feature block. Version 0.25.0 adds return-type-only overload disambiguation.

## Installation

```swift
.package(url: "https://github.com/RafaelPena31/MockSyn.git", from: "0.25.0")
```
